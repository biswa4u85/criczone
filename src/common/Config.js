...
export default {
    ...
    randerImage: (src, height, imgHeight) => {
        return <div style={{ objectFit: 'cover', height: height }}>
            <img style={{ textAlign:"center", height: (imgHeight ? imgHeight : 'inherit') }} src={src ? `${'https://news.techwizards.io'}${src}` : noData} alt="image" />
