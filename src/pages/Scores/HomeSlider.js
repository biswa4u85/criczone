            ...
            <div className="trending_news">
                <div className="lanka">
                    ...
                    <div className='srilanka'>
                        <img src={require(`../../assets/flags/AFGHANISTAN.gif`)} className="flagimg" /> <span> {item?.home?.name}</span>
                    </div>
                    <div className='srilanka'>
                        <img src={require(`../../assets/flags/AFGHANISTAN.gif`)} className="flagimg" /> <span>{item?.away?.name}</span>
                    </div>
